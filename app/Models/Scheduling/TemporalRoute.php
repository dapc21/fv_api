...
class TemporalRoute extends Moloquent
{
    use SoftDeletes;    
    use \App\Models\Generic\GenericModelTrait;
    
    //Equibalente a tables en moloquent
    protected $collection = 'temporalRoutes';
    //Para softdeleted
    ...
    protected $relationship_map = [
        ...
        [
            'type' =>'embedsmany',
            'foreign_controller' => 'App\Http\Controllers\Scheduling\TemporalTaskController',
            'pivot_id_parent' => '_id',
            'pivot_id_foreign'=> 'id_temporalTask',
        ],
    ];
    ...
    {
        return $this->embedsMany('App\Models\Scheduling\TemporalTask');
    }
}
